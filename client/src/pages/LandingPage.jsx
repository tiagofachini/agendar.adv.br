              ...
              {magicLinkSent ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl py-3 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-colors mb-5"
                  >
                    ...
                    {modal === 'register' ? 'Criar conta com Google' : 'Entrar com Google'}
                  </button>

                  <div className="flex items-center gap-3 mb-5">
                    <div className="flex-1 h-px bg-gray-200" />
                    <span className="text-xs text-gray-400 font-medium">ou acesse por email</span>
                    <div className="flex-1 h-px bg-gray-200" />
                  </div>
