      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              Ao criar uma conta ou utilizar o Agendar.ADV, você concorda integralmente com estes Termos de Uso.
          ...
          <section>
            ...
            <p>
              O Agendar.ADV é uma plataforma de gestão de agenda, clientes e cobranças desenvolvida exclusivamente
          ...
          <section>
            ...
            <p>
              Para utilizar o Agendar.ADV é necessário criar uma conta com informações verdadeiras e atualizadas.
          ...
          <section>
            ...
            <p className="mb-3">
              O Agendar.ADV oferece dois planos:
            </p>
            ...
            <p className="mt-3">
              O Agendar.ADV <strong>não processa pagamentos</strong> de clientes finais diretamente. A integração
            ...
            <p className="mt-3">
              ...
              é o valor bruto deduzido da respectiva taxa de processamento. O Agendar.ADV não retém nenhuma parte
          ...
          <section>
            ...
            <p>
              Todo o código-fonte, design, marca, logotipos e conteúdos do Agendar.ADV são de propriedade exclusiva
          ...
          <section>
            ...
            <p>
              Os dados dos clientes inseridos no Agendar.ADV (nome, e-mail, telefone, descrição de casos) são de
              responsabilidade exclusiva do advogado usuário. O Agendar.ADV trata esses dados como operador, conforme
          ...
          <section>
            ...
            <p>
              O Agendar.ADV não se responsabiliza por:
            </p>
            <ul className="list-disc list-inside mt-2 space-y-1 text-gray-600">
          ...
          <section>
            ...
            <p>
              ...
              cancelamento, os dados são mantidos por 30 dias e depois excluídos definitivamente. O Agendar.ADV
